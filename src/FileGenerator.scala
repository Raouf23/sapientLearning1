...
object FileGenerator {
 ...
 val startTime = System.nanoTime
    val input = Source.fromFile("C:\\Users\\raokhan\\workspace\\ScalaLearning\\input\\GreeceMapping.txt")
    val file = new File("C:\\Users\\raokhan\\workspace\\ScalaLearning\\output\\config_Greece.txt")
    ...
    for (line <- input.getLines()) {
            if (line.contains("post_event_list") | line.contains("event_list")) {
    ...
    pw.close()
     ...
     val input1 = Source.fromFile("C:\\Users\\raokhan\\workspace\\ScalaLearning\\input\\GreeceMapping.txt")
    val file1 = new File("C:\\Users\\raokhan\\workspace\\ScalaLearning\\output\\config_Greece.txt")
    val bw = new BufferedWriter(new FileWriter(file1, true))
    
    
    val input2 = Source.fromFile("C:\\Users\\raokhan\\workspace\\ScalaLearning\\input\\GreeceMapping.txt")
    val file2 = new File("C:\\Users\\raokhan\\workspace\\ScalaLearning\\output\\config_Greece.txt")
